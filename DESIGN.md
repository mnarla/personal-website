...
colors:
  ...
  accent: "#FF1E56"
  accent-hover: "#FF3B6F"
  accent-dim: "rgba(255, 30, 86, 0.12)"
  accent-glow: "rgba(255, 30, 86, 0.25)"
...
- **Primary Accent (`#FF1E56`):** Electric Crimson / Neon Ruby used strictly for active indicators, progress metrics, and key CTAs (~5% visual ratio).
